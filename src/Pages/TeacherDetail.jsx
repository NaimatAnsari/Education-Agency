    ...
    <div className="row">
      <div className="col-md-8">
        <ul className="list-inline custom-breadcrumb">
          <li className="list-inline-item"><a className="h2 text-primary font-secondary" href="teacher.html">Our Teacher</a></li>
          <li className="list-inline-item text-white h3 font-secondary nasted">John Doe</li>
        </ul>
  ...
  <div className="container">
    <div className="row">
      <div className="col-md-5 mb-5">
        <img className="img-fluid w-100" src="images/teachers/teacher-1.jpg" alt="teacher"/>
      </div>
      <div className="col-md-6 mb-5">
        <h3>John Doe</h3>
        <h6 className="text-color">Computer Science</h6>
        <p className="mb-5">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Cumque accusamus tenetur ea harum
        ...
        <div className="row">
          <div className="col-md-6 mb-5 mb-md-0">
            ...
            <ul className="list-unstyled">
              <li className="mb-3"><a className="text-color" href="mailto:johndoe@email.com"><i className="ti-email mr-2"></i>johndoe@email.com</a></li>
              <li className="mb-3"><a className="text-color" href="callto:+120345876"><i className="ti-mobile mr-2"></i>+120 345 876</a></li>
              <li className="mb-3"><a className="text-color" href="#"><i className="ti-facebook mr-2"></i>john Doe</a></li>
              <li className="mb-3"><a className="text-color" href="#"><i className="ti-twitter-alt mr-2"></i>john Doe</a></li>
              <li className="mb-3"><a className="text-color" href="#"><i className="ti-skype mr-2"></i>john Doe</a></li>
              <li className="mb-3"><a className="text-color" href="#"><i className="ti-world mr-2"></i>johnDoe.com</a></li>
              <li className="mb-3"><a className="text-color" href="#"><i className="ti-location-pin mr-2"></i>1313 Boulevard
                  Cremazie,Quebec</a></li>
            </ul>
          </div>
          <div className="col-md-6">
            <h4 className="mb-4">SUMMARY OF ACTIVITIES/INTERESTS</h4>
            <ul className="list-unstyled">
              <li className="mb-3">Computer Networking</li>
              <li className="mb-3">Computer Security</li>
              <li className="mb-3">Human Computer Interfacing</li>
            </ul>
          </div>
        </div>
      </div>
      <div className="col-12">
        ...
        <p className="mb-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et
